...
void ScrollingBackground::load(unique_ptr<LoaderParams> const &pParams)
{
...
{
    // draw first rect
    SDL_RenderCopyEx(theGame::Instance()->getRenderer(), _TextureManager::Instance()->getTextureMap()[m_textureID], &m_srcRect1, &m_destRect1, 0, 0, SDL_FLIP_NONE);
    
    // draw second rect
    SDL_RenderCopyEx(theGame::Instance()->getRenderer(), _TextureManager::Instance()->getTextureMap()[m_textureID], &m_srcRect2, &m_destRect2, 0, 0, SDL_FLIP_NONE);
}
