...
bool GameOverState::onEnter() 
{
    ...
    GameObject* gameOverText = new AnimatedGraphic(new LoaderParams(200, 100, 190, 30, 2, 0, 2, "gameover"));
    GameObject* button1 = new MenuButton(new LoaderParams(200, 200, 200, 80, 3, 0, 0, "mainbutton"), s_gameOverToMain); 
    GameObject* button2 = new MenuButton(new LoaderParams(200, 300, 200, 80, 3, 0, 0, "restartbutton"), s_restartPlay);
