...
bool MenuState::onEnter() 
{
    ...
    GameObject* button1 = new MenuButton::load(new LoaderParams(100, 100, 400, 100, 3, "playbutton"), s_menuToPlay);
    GameObject* button2 = new MenuButton::load(new LoaderParams(100, 300, 400, 100, 3, "exitbutton"), s_exitFromMenu);
